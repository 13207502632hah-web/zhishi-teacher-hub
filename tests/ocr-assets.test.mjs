...
test("browser OCR assets keep the configured universal LSTM core without unused duplicate binaries", async () => {
  ...
  assert.match(client, /corePath:\s*"\/ocr\/tesseract-core-lstm\.wasm\.js"/);
});
