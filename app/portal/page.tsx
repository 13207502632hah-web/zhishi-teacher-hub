...
export default function PortalPage() {
  ...
  if (sessionExpired) return <AppShell title="我的学习" subtitle="学生与家长移动门户"><StateCard title="登录状态已过期" description="为了保护学生资料，本次读取没有展示任何内容。请重新登录后再试。" action={retry} alert /></AppShell>;
