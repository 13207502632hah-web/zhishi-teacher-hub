...
export async function GET(_: Request, context: { params: Promise<{ id: string }> }) {
  ...
  return Response.json({ student, attention, lessonRecords: lessonRecords.results, submissions: submissionRows, feedback: feedbackRows.results, results: resultRows, wrongQuestions: wrongRows });
}
