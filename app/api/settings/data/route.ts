...
export async function DELETE(request: Request) {
  ...
  const tables = ["paper_questions", "lesson_questions", "assessment_results", "assessments", "assignment_submissions", "assignments", "attendance", "student_lesson_records", "feedback", "reflections", "enrollments", "papers", "questions", "question_sets", "lessons", "courses", "resources", "students", "classes"];
