...
export async function DELETE(request: Request) {
  ...
  const tables = ["paper_questions", "lesson_questions", "wrong_questions", "assessment_results", "student_mastery_adjustments", "assessments", "assignment_submissions", "assignments", "attendance", "student_lesson_records", "feedback", "reflections", "enrollments", "staff_class_access", "papers", "questions", "question_sets", "lessons", "courses", "resources", "demo_records", "students", "classes"];
