...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  return Response.json({ ok: true, paperId, assignmentId, added, paperHref: `/v2/detail/papers/${paperId}`, assignmentHref: `/v2/modules/assignments?lessonId=${lessonId}&status=draft` });
}
