...
export function V2Shell({ userName, role, children }: { userName: string; role: "teacher" | "assistant"; children: React.ReactNode }) {
  ...
  return <div className="v2-shell">
    ...
    <div className="v2-main">
      <header className="v2-topbar"><div><small>知师研室 2.0 / 内部测试</small><h1>{title}</h1></div><div className="v2-top-actions"><button className="v2-command" onClick={() => setPalette(true)}><span>⌕</span>搜索或执行命令<kbd>Ctrl K</kbd></button><Link className="v2-ai-launch" href="/v2/assistant"><span>✦</span> 问智能助手</Link></div></header>
