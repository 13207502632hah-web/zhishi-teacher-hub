...
- [x] 微信后台 `request`、`uploadFile`、`downloadFile` 域名已统一替换为
  ...
  修复版 2.0.1 已于 2026-08-13 上传，当前等待在微信公众平台重新提交审核。
...
- [x] Windows 微信开发者工具已安装、登录并开启服务端口，CLI 已成功上传修复版 2.0.1
  （包体 55,412 字节）。
...
- [x] 修复版 2.0.1 已上传；正式域名、业务 JSON、生产禁用保护、Lint 和生产构建门禁通过。
- [ ] 在微信公众平台将 2.0.1 重新提交审核；审核通过后只发布 2.0.1，绝不发布旧版 1.0.0。
